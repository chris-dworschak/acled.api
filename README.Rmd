...
```{r downloads, echo=FALSE, dpi=200, out.width=525, out.height=404, fig.align="center"}
...
acled.data$downloads <- as.numeric(acled.data$downloads)
x.vector <- 1:length(acled.data$date)
acled.data$cum.downloads <- acled.data$downloads
for(i in 2:length(x.vector)){acled.data$cum.downloads[i] <- acled.data$cum.downloads[i]+acled.data$cum.downloads[i-1]}
